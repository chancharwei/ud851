...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(R.string.pref_show_tremble_key),
                getResources().getBoolean(R.bool.pref_show_tremble_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_show_tremble_key))) {
            mVisualizerView.setShowTreble(sharedPreferences.getBoolean(key, getResources().getBoolean(R.bool.pref_show_tremble_default)));
        }
    }
