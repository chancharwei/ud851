...
public class MainActivity extends AppCompatActivity {
    ...
    public void shareTest(String toShare) {
        String mimType = "text/plain";
        String title = "how would you like to share your secrets?";

        ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimType).setText(toShare).startChooser();
    }
