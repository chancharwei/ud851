...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_NO_THANKS_ID = 3418;
    private static final int WATER_REMINDER_DRINK_ID = 3419;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        Intent i = new Intent(context, WaterReminderIntentService.class);
        i.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        PendingIntent pi = PendingIntent.getService(context, WATER_REMINDER_NO_THANKS_ID, i, PendingIntent.FLAG_UPDATE_CURRENT);

        return new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "no thanks", pi);
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        Intent i = new Intent(context, WaterReminderIntentService.class);
        i.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        PendingIntent pi = PendingIntent.getService(context, WATER_REMINDER_DRINK_ID, i, PendingIntent.FLAG_UPDATE_CURRENT);

        return new NotificationCompat.Action(R.drawable.ic_drink_notification, "done", pi);
    }
