...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent reminderServiceIntent = new Intent(this, WaterReminderIntentService.class);
        reminderServiceIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
