...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor result = getAllGuests();

        // TODO (12) Pass the resulting cursor count to the adapter

        // Create an adapter for that cursor to display the data
        mAdapter = new GuestListAdapter(this, result.getCount());
    ...
    private Cursor getAllGuests() {
        ...
        columns[0] = WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME;
        columns[1] = WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE;
        columns[2] = WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP;
        return mDb.query(WaitlistContract.WaitlistEntry.TABLE_NAME, columns, null, null, null, null, WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP);
    }
