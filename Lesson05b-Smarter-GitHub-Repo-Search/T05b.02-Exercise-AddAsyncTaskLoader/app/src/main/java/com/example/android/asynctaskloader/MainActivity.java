...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private int GITHUB_SEARH_LOADER = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(GITHUB_SEARH_LOADER, null, this);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery.isEmpty()) {
            mUrlDisplayTextView.setText("nothing to search for");
        }
        ...
        lm.restartLoader(GITHUB_SEARH_LOADER, queryBundle, this);
